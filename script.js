...
( () => require( './lib/lib.js' )() )()
},{"./lib/lib.js":3}],3:[function(require,module,exports){
module.exports = () => {
     ...
     * @param {string} coin
     */
    const appendCoinPrice = ( element, price, coin ) => {
        ...
        element.firstChild
            ...
            .lastChild
            .firstChild
            .innerText = `${ coin.toUpperCase() }\n$${ price.toFixed( 8 ) }`

    }

    /**
     * @param {string} coin
     * @param {string} coingekoId
     */
    const coinObserver = ( coin, coingekoId ) => new MutationObserver( ( _, obs ) => {

        console.log( `observing for ${ coin }!` )
        ...
        if ( element ) {
            ...
            axios.get( `https://api.coingecko.com/api/v3/simple/price?ids=${ coingekoId }&vs_currencies=usd` )
                .then( res => appendCoinPrice( element, res.data[ coingekoId ][ 'usd' ], coin ) )
...
},{"axios":4,"jquery":33}],4:[function(require,module,exports){
